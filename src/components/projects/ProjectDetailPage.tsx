...
export default function ProjectDetailPage({ params }: { params: Promise<Params> }) {
  ...
  return <div className="project-module space-y-6">
    ...
    {["cockpit", "planning", "quality", "finance"].includes(tab) && <HrSectionCard icon={SlidersHorizontal} title="Périmètre du détail" description="Affinez les objets du projet affichés dans l’onglet actif ; les cartes, tableaux et graphiques suivent ce même périmètre.">
