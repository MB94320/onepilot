    ...
    chapters: [
      {
        ...
        icon: Files,
        exact: true,
        keywords: ["fichiers", "documents", "outils"],
      },
      {
        id: "document-library",
        ...
        icon: BookOpenCheck,
        exact: true,
        keywords: ["pdf", "bibliothèque", "référentiel"],
      },
      {
        ...
        icon: FileCheck2,
        exact: true,
        keywords: ["modèles", "trames", "versions"],
      },
      {
        id: "document-processes",
        label: "Processus",
        href: "/documents/processus",
        icon: Route,
        exact: true,
        keywords: ["processus", "procédures", "contrôles"],
      },
      {
        id: "document-sharing",
        label: "Partages",
        href: "/documents/partages",
        icon: UserCheck,
        exact: true,
        keywords: ["partage", "droits", "destinataires"],
      },
      {
        id: "automation",
        label: "Automatisations",
        href: "/documents/automatisations",
        icon: Sparkles,
        exact: true,
        keywords: [
          "workflow",
...
export const administrationNavigationSection: NavigationSection = {
  id: "administration",
  label: "Administration plateforme",
  icon: ShieldCheck,
  accent: "slate",
  chapters: [
    { id: "admin-overview", label: "Vue d’ensemble", href: "/admin", icon: LayoutDashboard, exact: true },
    { id: "admin-organizations", label: "Organisations", href: "/admin/organisations", icon: Building2, exact: true },
    { id: "admin-users", label: "Utilisateurs & rôles", href: "/admin/utilisateurs", icon: Users, exact: true },
    { id: "admin-subscriptions", label: "Offres & abonnements", href: "/admin/abonnements", icon: CreditCard, exact: true },
    { id: "admin-security", label: "Sécurité & audit", href: "/admin/securite", icon: ShieldCheck, exact: true },
    { id: "admin-settings", label: "Paramétrage plateforme", href: "/admin/parametrage", icon: SlidersHorizontal, exact: true },
  ],
};
